...
class OrderProductTestCase(TestCase):
    def setUp(self):
        ...
        OrderProduct.objects.create(session_id="36794cfc-f122-401a-bfb5-47b27d772708", product=product, quantity=2)
    
    def test_order_product_create(self):
        order_product = OrderProduct.objects.get(session_id="36794cfc-f122-401a-bfb5-47b27d772708")
